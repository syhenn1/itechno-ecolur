...
**EcoLur** (*"Eco"* + *"Lur"*, from **Bojong Kulur**, Gunung Putri, Kabupaten Bogor — the pilot area) — a web platform for the ITechno Cup 2026 competition (sub-theme *Smart Sustainable Digital Solution for Inclusive Society*), combining two modules:
