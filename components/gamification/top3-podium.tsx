...
export function Top3Podium({
  ...
  return (
    <div
      className={cn(
        "rounded-3xl border border-amber-200/90 bg-gradient-to-br from-amber-50/50 via-white to-yellow-50/30 shadow-xs relative overflow-hidden",
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 border-b border-amber-100/80 pb-2">
        <div className="flex items-center gap-2">
          <span
            className={cn(
              "flex items-center justify-center rounded-xl bg-amber-100 text-amber-700 shadow-2xs shrink-0",
          ...
          <div>
            <h3 className={cn("font-extrabold text-slate-900 leading-tight", compact ? "text-xs" : "text-sm")}>
              Papan Peringkat 10 Besar Warga
            </h3>
            {!compact && <p className="text-[10px] text-slate-500">Desa Bojong Kulur &middot; Musim 2026</p>}
          </div>
        </div>

        <div className="flex items-center gap-1.5">
          <span className="text-[9px] font-black text-amber-800 bg-amber-100/90 px-2 py-0.5 rounded-full border border-amber-300 whitespace-nowrap shrink-0">
            Musim 2026
          </span>
        </div>
      </div>
      ...
      <div className={cn("grid grid-cols-3 gap-2 items-end", compact ? "pt-1" : "pt-2")}>
        ...
        {top2 && (
          <div className="flex flex-col items-center text-center min-w-0">
            ...
            <div
              className={cn(
                "w-full rounded-t-xl bg-gradient-to-b from-slate-300 via-slate-200 to-slate-300/90 border-t-2 border-slate-400 p-1 shadow-inner flex flex-col items-center justify-center",
        ...
        {top1 && (
          <div className="flex flex-col items-center text-center min-w-0 relative">
            ...
            <div
              className={cn(
                "w-full rounded-t-xl bg-gradient-to-b from-amber-400 via-yellow-400 to-amber-500 border-t-2 border-yellow-200 p-1 shadow-md eco-glow-gold flex flex-col items-center justify-center relative",
        ...
        {top3 && (
          <div className="flex flex-col items-center text-center min-w-0">
            ...
            <div
              className={cn(
                "w-full rounded-t-xl bg-gradient-to-b from-amber-200 via-amber-100 to-amber-200/90 border-t-2 border-amber-300 p-1 shadow-inner flex flex-col items-center justify-center",
      ...
      <div className="pt-2 border-t border-amber-100 flex flex-col gap-2">
        ...
        {onViewFullLeaderboard ? (
          <button
            ...
            className="w-full text-center text-xs font-extrabold text-emerald-900 bg-white hover:bg-emerald-50 py-2 px-3 rounded-xl border border-emerald-200 shadow-2xs transition-colors flex items-center justify-center gap-1 cursor-pointer"
          >
            <span>Buka Papan Peringkat Lengkap &amp; Paginasi</span>
