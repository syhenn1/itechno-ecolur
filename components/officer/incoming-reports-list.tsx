    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-md border border-amber-200 bg-white p-5">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Antrean baru</span>
            <span className="flex h-8 w-8 items-center justify-center rounded-md bg-amber-50 text-amber-700">
              <AlertTriangle className="h-4 w-4" />
            </span>
          </div>
          <div className="mt-2 text-2xl sm:text-3xl font-bold text-amber-900 font-mono">{stats.reported}</div>
          <div className="mt-1 text-[11px] font-medium text-amber-700">Perlu verifikasi</div>
        </div>

        <div className="rounded-md border border-sky-200 bg-white p-5">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Sedang ditangani</span>
            <span className="flex h-8 w-8 items-center justify-center rounded-md bg-sky-50 text-sky-700">
              <Clock className="h-4 w-4" />
            </span>
          </div>
          <div className="mt-2 text-2xl sm:text-3xl font-bold text-sky-900 font-mono">{stats.inProgress}</div>
        ...
        <div className="rounded-md border border-emerald-200 bg-white p-5">
          ...
          <div className="mt-2 text-2xl sm:text-3xl font-bold text-emerald-900 font-mono">{stats.resolved}</div>
          <div className="mt-1 text-[11px] font-medium text-emerald-700">Laporan tuntas</div>
        </div>

        <div className="rounded-md border border-slate-200 bg-white p-5">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Jarak terdekat</span>
      ...
      <div className="rounded-md border border-slate-200 bg-white p-5 space-y-4">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="inline-flex rounded-md border border-slate-200 bg-slate-50 p-1 flex-wrap gap-1">
              <button
                type="button"
                onClick={() => setSortMode("KNN_DISTANCE")}
                className={cn(
                  "inline-flex items-center gap-1.5 rounded-md px-3.5 py-2 text-xs font-semibold transition-all duration-150 hover:-translate-y-0.5 cursor-pointer",
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pt-1 border-t border-slate-100">
          {[
            ...
            <button
              ...
              className={cn(
                "rounded-xl px-3 py-1.5 text-xs font-bold transition-all duration-150 hover:-translate-y-0.5 whitespace-nowrap cursor-pointer",
      ...
      <div className="grid gap-6 lg:grid-cols-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-6">
          {activeReport ? (
            <Card className="border-slate-200 bg-white rounded-md overflow-hidden p-0">
              <div className="bg-slate-900 text-white p-5 flex flex-col gap-2.5">
                <div className="flex items-center justify-between gap-2">
                  <span className="rounded-md bg-white/10 px-3 py-0.5 text-[10px] font-bold text-white uppercase tracking-wider">
                    Detail laporan
                  </span>
